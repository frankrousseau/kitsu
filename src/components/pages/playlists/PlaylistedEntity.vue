...
<div class="flexrow wrapper">
  <drag @drag="onDragged" :transfer-data="entity.id">
    ...
    >
      ...
      <div class="entity-title">{{ entity.parent_name }} / {{ entity.name }}</div>
...
<script>
/*
 * Widget to describe a entity listed in a playlist. It allows to select a given
 * prevision for a given task type for current entity.
