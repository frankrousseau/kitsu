...
export default {
  ...
  methods: {
    ...
    updateTaskPanel () {
      if (this.entityList.length > 0) {
        ...
        console.log('updateTaskPanel', entity)
        console.log(this.taskMap[entity.preview_file_task_id])
  ...
  watch: {
    playingEntityIndex () {
      console.log('playingENtityINdex')
